...
public class PostDaoImpl implements PostDao {
    ...
    @Override
    public GenericResponse likePost(PostIDCommentRequest postId) {
        //logger.info("Delete Post by ID Request ::: " + postId);
        ...
        try{
            connection = dataSource.getConnection();
            //connection = cardOracleDataSource().getConnection();
            String query = "call BLOGVOTE.proc_likes_count(?,?,?)";
            callableStatement = connection.prepareCall(query);
            callableStatement.setLong(1, postId.getPostId());
            callableStatement.registerOutParameter(2,Types.VARCHAR);
            callableStatement.registerOutParameter(3, Types.VARCHAR);
            callableStatement.execute();
    ...
    @Override
    public GenericResponse undoLikePost(PostIDCommentRequest postId) {
        //logger.info("Delete Post by ID Request ::: " + postId);
        ...
        try{
            connection = dataSource.getConnection();
            //connection = cardOracleDataSource().getConnection();
            String query = "call BLOGVOTE.proc_undo_likes(?,?,?)";
            callableStatement = connection.prepareCall(query);
            callableStatement.setLong(1, postId.getPostId());
            callableStatement.registerOutParameter(2,Types.VARCHAR);
            callableStatement.registerOutParameter(3, Types.VARCHAR);
    ...
    @Override
    public GenericResponse dislikePost(PostIDCommentRequest postId) {
        //logger.info("Delete Post by ID Request ::: " + postId);
        ...
        try{
            connection = dataSource.getConnection();
            //connection = cardOracleDataSource().getConnection();
            String query = "call BLOGVOTE.proc_dislikes_count(?,?,?)";
            callableStatement = connection.prepareCall(query);
            callableStatement.setLong(1, postId.getPostId());
            callableStatement.registerOutParameter(2,Types.VARCHAR);
            callableStatement.registerOutParameter(3, Types.VARCHAR);
    ...
    @Override
    public GenericResponse undoDislikePost(PostIDCommentRequest postId) {
        //logger.info("Delete Post by ID Request ::: " + postId);
        ...
        try{
            connection = dataSource.getConnection();
            //connection = cardOracleDataSource().getConnection();
            String query = "call BLOGVOTE.proc_undo_dislike(?,?,?)";
            callableStatement = connection.prepareCall(query);
            callableStatement.setLong(1, postId.getPostId());
            callableStatement.registerOutParameter(2,Types.VARCHAR);
            callableStatement.registerOutParameter(3, Types.VARCHAR);
